    ...
    ,frameStats_()
{
    ...
    registerParameter("localaddress", "Address of this client", "0", false, localAddress_x);
    ...
    registerParameter("debug","Whether to output debug information","false",false,debug_x);
}
