/**
 * \file components/gpp/phy/TutOfdmModulator/TutOfdmModulatorComponent.h
 * \version 1.0
 *
 * \section COPYRIGHT
 *
...
#ifndef PHY_TUTOFDMMODULATORCOMPONENT_H_
#define PHY_TUTOFDMMODULATORCOMPONENT_H_
 ...
 *             -----------------------------------                         <br>
 */
class TutOfdmModulatorComponent
  : public PhyComponent
{
 public:
  ...
  TutOfdmModulatorComponent(std::string name);
  ~TutOfdmModulatorComponent();
 ...
 private:
  ...
  Complexplot* preamblePlot_;
  Complexplot* binsPlot_;
  Complexplot* framePlot_;
...
#endif // PHY_TUTOFDMMODULATORCOMPONENT_H_
