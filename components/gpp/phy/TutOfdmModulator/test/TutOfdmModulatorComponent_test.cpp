/**
 * \file components/gpp/phy/TutOfdmModulator/test/TutOfdmModulatorComponent_test.cpp
 * \version 1.0
 *
 * \section COPYRIGHT
 *
 ...
 * \section DESCRIPTION
 *
 * Main test file for TutOfdmModulator component.
 */

#define BOOST_TEST_MODULE TutOfdmModulatorComponent_Test
...
BOOST_AUTO_TEST_SUITE (TutOfdmModulatorComponent_Test)

BOOST_AUTO_TEST_CASE(TutOfdmModulatorComponent_Basic_Test)
{
  BOOST_REQUIRE_NO_THROW(TutOfdmModulatorComponent mod("test"));
}

BOOST_AUTO_TEST_CASE(TutOfdmModulatorComponent_Parm_Test)
{
  TutOfdmModulatorComponent mod("test");
...
BOOST_AUTO_TEST_CASE(TutOfdmModulatorComponent_Ports_Test)
{
  TutOfdmModulatorComponent mod("test");
...
BOOST_AUTO_TEST_CASE(TutOfdmModulatorComponent_Init_Test)
{
  TutOfdmModulatorComponent mod("test");
  mod.registerPorts();
...
BOOST_AUTO_TEST_CASE(TutOfdmModulatorComponent_Process_Test)
{
  TutOfdmModulatorComponent mod("test");
  mod.registerPorts();
...
/*
BOOST_AUTO_TEST_CASE(TutOfdmModulatorComponent_Generate_Data)
{
  TutOfdmModulatorComponent mod("test");
