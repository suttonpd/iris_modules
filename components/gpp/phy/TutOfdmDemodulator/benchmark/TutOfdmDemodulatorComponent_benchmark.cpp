/**
 * \file components/gpp/phy/TutOfdmDemodulator/benchmark/TutOfdmDemodulatorComponent_benchmark.cpp
 * \version 1.0
 *
 * \section COPYRIGHT
 *
 ...
 * \section DESCRIPTION
 *
 * Main benchmark file for TutOfdmDemodulator component.
 */

#include "../TutOfdmDemodulatorComponent.h"
#include <boost/date_time/posix_time/posix_time.hpp>
#include "TutOfdmDemodulatorBenchmarkData.h"
...
int main(int argc, char* argv[])
{
  ...
  int numFrames = 10000;
  int frameSize = TutOfdmDemodulatorBenchmarkData::testFrame1.size();
  ...
  {
    copy(TutOfdmDemodulatorBenchmarkData::testFrame1.begin(),
         TutOfdmDemodulatorBenchmarkData::testFrame1.end(),
         it);
  }
