/**
 * \file components/gpp/phy/TutOfdmDemodulator/TutOfdmDemodulatorComponent.h
 * \version 1.0
 *
 * \section COPYRIGHT
 *
 ...
 *             -----------------------------------                         <br>
 */
class TutOfdmDemodulatorComponent
  : public PhyComponent
{
public:
  ...
  TutOfdmDemodulatorComponent(std::string name);
  ~TutOfdmDemodulatorComponent();
...
private:
  ...
  bool plotFrameDetect_x;
  bool plotRxPreamble_x;
  bool plotEq_x;
  bool plotSymbols_x;
  ...
  Realplot* frameDetectPlot_;
  Complexplot* rxPreamblePlot_;
  Complexplot* eqPlot_;
  Scatterplot* symbolPlot_;
