/**
 * \file components/gpp/phy/DemoOfdmDemodulator/DemoOfdmDemodulatorComponent.h
 * \version 1.0
 *
 * \section COPYRIGHT
 *
 ...
 *
 * This corresponds to the default shape generated with the DemoOfdmModulator
 * component when receiving with bandwidth X/2 where X is the transmit
 * bandwidth. See DemoOfdmModulatorComponent.h for more information.
 */

#ifndef PHY_DEMOOFDMDEMODULATORCOMPONENT_H_
#define PHY_DEMOOFDMDEMODULATORCOMPONENT_H_

#include <boost/scoped_ptr.hpp>

#include "irisapi/PhyComponent.h"
#include "modulation/DemoOfdmPreambleDetector.h"
 ...
 *             -----------------------------------                         <br>
 */
class DemoOfdmDemodulatorComponent
  : public PhyComponent
{
public:
  ...
  DemoOfdmDemodulatorComponent(std::string name);
...
private:
  ...
  DemoOfdmPreambleDetector detector_;           ///< Our preamble detector.
...
#endif // PHY_DEMOOFDMDEMODULATORCOMPONENT_H_
