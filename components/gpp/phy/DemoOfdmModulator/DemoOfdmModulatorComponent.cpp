/**
 * \file components/gpp/phy/DemoOfdmModulator/DemoOfdmModulatorComponent.cpp
 * \version 1.0
 *
 * \section COPYRIGHT
 *
 ...
 * \section DESCRIPTION
 *
 * Implementation of the DemoOfdmModulator component.
 */

#include "DemoOfdmModulatorComponent.h"
...
IRIS_COMPONENT_EXPORTS(PhyComponent, DemoOfdmModulatorComponent);

DemoOfdmModulatorComponent::DemoOfdmModulatorComponent(std::string name)
  : PhyComponent(name,                          // component name
                "demoofdmmodulator",                // component type
...
void DemoOfdmModulatorComponent::initialize()
{
  setup();
}

void DemoOfdmModulatorComponent::process()
{
...
void DemoOfdmModulatorComponent::parameterHasChanged(std::string name)
{
...
void DemoOfdmModulatorComponent::setup()
{
 ...
 */
void DemoOfdmModulatorComponent::createHeader(ByteVecIt begin, ByteVecIt end)
{
  //Add the CRC
 ...
 */
void DemoOfdmModulatorComponent::createFrame(ByteVecIt begin, ByteVecIt end)
{
 ...
 */
void DemoOfdmModulatorComponent::createSymbol(CplxVecIt inBegin, CplxVecIt inEnd,
                                          CplxVecIt outBegin, CplxVecIt outEnd)
{
  ...
  transform(outBegin, outEnd, outBegin, bl::_1/scaleFactor);

  plotter_.plot(fftBins_.begin(), fftBins_.end(), "Frequency", 1);
  plotter_.plot(outBegin, outEnd, "Time", 2);
}

DemoOfdmModulatorComponent::CplxVecIt
DemoOfdmModulatorComponent::copyWithCp(CplxVecIt inBegin, CplxVecIt inEnd,
                                   CplxVecIt outBegin, CplxVecIt outEnd)
{
