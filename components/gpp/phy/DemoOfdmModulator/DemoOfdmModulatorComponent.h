/**
 * \file components/gpp/phy/DemoOfdmModulator/DemoOfdmModulatorComponent.h
 * \version 1.0
 *
 * \section COPYRIGHT
 *
 ...
 * \section DESCRIPTION
 *
 * A demonstration OFDM modulation component. Provides graphical output of all
 * major algorithmic steps. Takes a block of data bytes in uint8_t format and
 * outputs a full OFDM frame of complex<float> symbols with the following
 * structure:                                                              <br>
 *             -----------------------------------                         <br>
...
#ifndef PHY_DEMOOFDMMODULATORCOMPONENT_H_
#define PHY_DEMOOFDMMODULATORCOMPONENT_H_
 ...
 *             -----------------------------------                         <br>
 */
class DemoOfdmModulatorComponent
  : public PhyComponent
{
 public:
  ...
  DemoOfdmModulatorComponent(std::string name);
...
#endif // PHY_DEMOOFDMMODULATORCOMPONENT_H_
